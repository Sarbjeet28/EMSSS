...
class Employee:
    def __init__(self, root):
        ...
        lbl_title = Label(self.root, text='EMPLOYEE MANAGEMENT SYSTEM', font=('times new roman', 32, 'bold'),
        ...
        # img logo
        img_logo = Image.open(r"C:\Users\Sarbjeet\PycharmProjects\EMS\Ems images\logo.jpg")
        img_logo = img_logo.resize((65, 65), Image.Resampling.LANCZOS)
        self.photo_logo = ImageTk.PhotoImage(img_logo)

        self.logo = Label(self.root, image=self.photo_logo)
        self.logo.place(x=318, y=0, width=50, height=50)
        ...
        # empimg1
        img_1 = Image.open(r"C:\Users\Sarbjeet\PycharmProjects\EMS\Ems images\img1.png")
        ...
        # empimg2
        img_2 = Image.open(r"C:\Users\Sarbjeet\PycharmProjects\EMS\Ems images\img2.png")
        ...
        # empimg3
        img_3 = Image.open(r"C:\Users\Sarbjeet\PycharmProjects\EMS\Ems images\img3.png")
        ...
        lbl_dep.grid(row=0, column=0, padx=7, pady=7, sticky=W)

        combo_dep = ttk.Combobox(upper_frame, textvariable=self.var_dep, font=("arial", 10, "bold"), width=25,
                                 state="readonly")
        ...
        lbl_Name.grid(row=0, column=2, padx=7, pady=7, sticky=W)

        txt_name = ttk.Entry(upper_frame, textvariable=self.var_name, width=30, font=("arial", 10, "bold"))
        ...
        lbl_Designation.grid(row=1, column=0, padx=7, pady=7, sticky=W)

        txt_Designation = ttk.Entry(upper_frame, textvariable=self.var_designation, width=28,
                                    font=("arial", 10, "bold"))
        ...
        lbl_Email.grid(row=1, column=2, padx=7, pady=7, sticky=W)

        txt_email = ttk.Entry(upper_frame, textvariable=self.var_email, width=30, font=("arial", 10, "bold"))
        ...
        lbl_Address.grid(row=2, column=0, padx=7, pady=7, sticky=W)

        txt_address = ttk.Entry(upper_frame, textvariable=self.var_address, width=28, font=("arial", 10, "bold"))
        txt_address.grid(row=2, column=1, padx=7, pady=7, sticky=W)

        # Married
        lbl_married_status = Label(upper_frame, text="Married Status:", font=("arial", 10, "bold"), fg="black",
                                   bg="white")
        ...
        lbl_dob.grid(row=3, column=0, padx=7, pady=7, sticky=W)

        txt_dob = ttk.Entry(upper_frame, textvariable=self.var_dob, width=28, font=("arial", 10, "bold"))
        ...
        lbl_doj.grid(row=3, column=2, padx=7, pady=7, sticky=W)

        txt_doj = ttk.Entry(upper_frame, textvariable=self.var_doj, width=30, font=("arial", 10, "bold"))
        ...
        com_txt_proof.grid(row=4, column=0, padx=7, pady=7, sticky=W)

        txt_proof = ttk.Entry(upper_frame, textvariable=self.var_idproof, width=28, font=("arial", 10, "bold"))
        ...
        lbl_gender.grid(row=4, column=2, padx=7, pady=7, sticky=W)
        ...
        lbl_phone.grid(row=0, column=4, padx=10, pady=7, sticky=W)

        txt_phone = ttk.Entry(upper_frame, textvariable=self.var_phone, width=30, font=("arial", 10, "bold"))
        txt_phone.grid(row=0, column=5, padx=10, pady=7)

        # country
        lbl_country = Label(upper_frame, text="Country:", font=("arial", 10, "bold"), fg="black", bg="white")
        lbl_country.grid(row=1, column=4, padx=10, pady=7, sticky=W)

        txt_country = ttk.Entry(upper_frame, textvariable=self.var_country, width=30, font=("arial", 10, "bold"))
        txt_country.grid(row=1, column=5, padx=10, pady=7)

        # CTC
        lbl_ctc = Label(upper_frame, text="Salary(CTC):", font=("arial", 10, "bold"), fg="black", bg="white")
        lbl_ctc.grid(row=2, column=4, padx=10, pady=7, sticky=W)

        txt_ctc = ttk.Entry(upper_frame, textvariable=self.var_salary, width=30, font=("arial", 10, "bold"))
        txt_ctc.grid(row=2, column=5, padx=10, pady=7)

        # empimg4
        img_4 = Image.open('F:/Python/Project/empimages/empimg4.png')
        img_4 = img_4.resize((140, 150), Image.Resampling.LANCZOS)
        self.photo4 = ImageTk.PhotoImage(img_4)

        self.img_4 = Label(upper_frame, image=self.photo4)
        self.img_4.place(x=1100, y=20, width=140, height=150)

        # img_4=Image.open('F:/Python/Project/empimages/empimg9.jpg')
        # img_4=img_4.resize((150,150),Image.Resampling.LANCZOS)
        # self.photo4=ImageTk.PhotoImage(img_4)

        # self.img_4=Label(upper_frame,image=self.photo4)
        # self.img_4.place(x=1090,y=18,width=150,height=150)
        ...
        search_frame = LabelFrame(lower_frame, bd=2, relief=RIDGE, text='Search Employee Information',
                                  font=('times new roman', 11, 'bold'), fg='blue', bg='white')
        ...
        btn__search = Button(search_frame, text="Search", command=self.search_data, font=("arial", 10, "bold"),
                             width=14, bg="orange", fg="white")
        btn__search.grid(row=0, column=3, padx=5)

        btn_ShowAll = Button(search_frame, text="Show All", command=self.fetch_data, font=("arial", 10, "bold"),
                             width=14, bg="orange", fg="white")
        btn_ShowAll.grid(row=0, column=4, padx=5)

        # btn__search=Button(search_frame,text="Search",font=("arial",10,"bold"),width=14,bg="orange",fg="white")
        # btn__search.grid(row=0,column=3,padx=5)

        # btn_ShowAll=Button(search_frame,text="Show All",font=("arial",10,"bold"),width=14,bg="orange",fg="white")
        # btn_ShowAll.grid(row=0,column=4,padx=5)
    ...
    def add_data(self):
        if self.var_dep.get() == "" or self.var_email.get() == "":
            ...
            try:
                conn = mysql.connector.connect(user='root', password='sonal@2024', host='127.0.0.1', port='3306',
                                               database='employeeform', auth_plugin='mysql_native_password')
                my_cursor = conn.cursor()
                my_cursor.execute('insert into employee values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)', (
                self.var_dep.get(), self.var_name.get(), self.var_designation.get(), self.var_email.get(),
                self.var_address.get(), self.var_married.get(), self.var_dob.get(), self.var_doj.get(),
                self.var_idproofcomb.get(), self.var_idproof.get(), self.var_gender.get(), self.var_phone.get(),
        ...
        if self.var_dep.get() == "" or self.var_email.get() == "":
            ...
            try:
                ...
                if update > 0:
                    ...
                    my_cursor = conn.cursor()
                    my_cursor.execute(
                        'update employee set Department=%s,Name=%s,Designation=%s,Email=%s,Address=%s,Married=%s,DOB=%s,DOJ=%s,ID_Type=%s,Gender=%s,Phone=%s,Country=%s,Salary=%s where ID_Proof=%s',
                        (self.var_dep.get(), self.var_name.get(), self.var_designation.get(), self.var_email.get(),
                         self.var_address.get(), self.var_married.get(), self.var_dob.get(), self.var_doj.get(),
                         self.var_idproofcomb.get(), self.var_gender.get(), self.var_phone.get(),
                         self.var_country.get(), self.var_salary.get(), self.var_idproof.get()))
